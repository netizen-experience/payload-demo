...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_menu_items_allergens" AS ENUM('gluten', 'shellfish', 'fish', 'soy', 'sesame', 'egg', 'dairy', 'nuts');
  CREATE TYPE "public"."enum_menu_items_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__menu_items_v_version_allergens" AS ENUM('gluten', 'shellfish', 'fish', 'soy', 'sesame', 'egg', 'dairy', 'nuts');
  CREATE TYPE "public"."enum__menu_items_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__menu_items_v_published_locale" AS ENUM('en', 'zh');
  ...
  CREATE TABLE "pages_blocks_featured_dishes" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"show_all" boolean DEFAULT false,
  	"view_all_link" varchar DEFAULT '/menu',
  	"block_name" varchar
  );
  
  CREATE TABLE "pages_blocks_featured_dishes_locales" (
  	"heading" varchar DEFAULT 'Featured Dishes',
  	"subheading" varchar DEFAULT 'Crafted with the finest ingredients',
  ...
  CREATE TABLE "_pages_v_blocks_featured_dishes" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_featured_dishes_locales" (
  	"heading" varchar DEFAULT 'Featured Dishes',
  	"subheading" varchar DEFAULT 'Crafted with the finest ingredients',
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "_menu_items_v_version_allergens" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum__menu_items_v_version_allergens",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE "footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"phone" varchar DEFAULT '+852 2345 6789',
  	"email" varchar DEFAULT 'info@matsu-sushi.hk',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "footer_locales" (
  	"address" varchar DEFAULT 'G/F, 88 Stanley Street, Central, Hong Kong',
  	"hours" varchar DEFAULT 'Mon–Sun: 12:00 – 22:30',
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  ALTER TABLE "pages_blocks_featured_dishes" ADD CONSTRAINT "pages_blocks_featured_dishes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_featured_dishes_locales" ADD CONSTRAINT "pages_blocks_featured_dishes_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_featured_dishes"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_featured_dishes" ADD CONSTRAINT "_pages_v_blocks_featured_dishes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_featured_dishes_locales" ADD CONSTRAINT "_pages_v_blocks_featured_dishes_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_featured_dishes"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "menu_items_locales" ADD CONSTRAINT "menu_items_locales_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_menu_items_v_version_allergens" ADD CONSTRAINT "_menu_items_v_version_allergens_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_menu_items_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_menu_items_v_locales" ADD CONSTRAINT "_menu_items_v_locales_version_meta_image_id_media_id_fk" FOREIGN KEY ("version_meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "search_rels" ADD CONSTRAINT "search_rels_menu_items_fk" FOREIGN KEY ("menu_items_id") REFERENCES "public"."menu_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_featured_dishes_order_idx" ON "pages_blocks_featured_dishes" USING btree ("_order");
  CREATE INDEX "pages_blocks_featured_dishes_parent_id_idx" ON "pages_blocks_featured_dishes" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_featured_dishes_path_idx" ON "pages_blocks_featured_dishes" USING btree ("_path");
  CREATE UNIQUE INDEX "pages_blocks_featured_dishes_locales_locale_parent_id_unique" ON "pages_blocks_featured_dishes_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "pages_rels_menu_items_id_idx" ON "pages_rels" USING btree ("menu_items_id","locale");
  ...
  CREATE INDEX "_pages_v_blocks_featured_dishes_order_idx" ON "_pages_v_blocks_featured_dishes" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_featured_dishes_parent_id_idx" ON "_pages_v_blocks_featured_dishes" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_featured_dishes_path_idx" ON "_pages_v_blocks_featured_dishes" USING btree ("_path");
  CREATE UNIQUE INDEX "_pages_v_blocks_featured_dishes_locales_locale_parent_id_uni" ON "_pages_v_blocks_featured_dishes_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "_pages_v_rels_menu_items_id_idx" ON "_pages_v_rels" USING btree ("menu_items_id","locale");
  ...
  CREATE INDEX "menu_items_meta_meta_image_idx" ON "menu_items_locales" USING btree ("meta_image_id","_locale");
  CREATE UNIQUE INDEX "menu_items_locales_locale_parent_id_unique" ON "menu_items_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "_menu_items_v_version_allergens_order_idx" ON "_menu_items_v_version_allergens" USING btree ("order");
  CREATE INDEX "_menu_items_v_version_allergens_parent_idx" ON "_menu_items_v_version_allergens" USING btree ("parent_id");
  ...
  CREATE INDEX "_menu_items_v_version_meta_version_meta_image_idx" ON "_menu_items_v_locales" USING btree ("version_meta_image_id","_locale");
  ...
  CREATE INDEX "search_rels_menu_items_id_idx" ON "search_rels" USING btree ("menu_items_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_featured_dishes" CASCADE;
  DROP TABLE "pages_blocks_featured_dishes_locales" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_featured_dishes" CASCADE;
  DROP TABLE "_pages_v_blocks_featured_dishes_locales" CASCADE;
  ...
  DROP TYPE "public"."enum__menu_items_v_version_allergens";
